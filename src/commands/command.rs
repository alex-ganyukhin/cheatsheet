...
pub trait CommandImplementation {
    fn execute(context: &CommandContext, cli: &crate::cli::CheatsheetCli) -> Result<(), anyhow::Error>;
}

pub struct NotImplementedCommandImplementation;

impl CommandImplementation for NotImplementedCommandImplementation {
    fn execute(_context: &CommandContext, _cli: &crate::cli::CheatsheetCli) -> Result<(), anyhow::Error> {
        spdlog::warn!(
